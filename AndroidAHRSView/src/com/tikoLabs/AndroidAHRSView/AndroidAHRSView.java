...
public class AndroidAHRSView extends View {
    ...
    public AndroidAHRSView(Context context) {
        super(context);
    }

    public AndroidAHRSView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAHRSView();
    }

    public AndroidAHRSView(Context context, AttributeSet attrs, int defaultStyle) {
